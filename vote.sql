...
create sequence  seq_userid  increment by 1 start with 10001; 
...
(
  voIds     NUMBER(10) primary key,  --编号
...
(
  ...
  voIds      NUMBER(10) not null, --投票选项id
...
--添加主题中的选项
insert into VoteOption (voIds, voOption, vsId, voOrder)
...
--添加选择结果
insert into VoteItem (viId, voIds, vsId,vuId)
